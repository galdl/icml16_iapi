function [theta_post,phi_hist_post] = evaluate_theta_pi_externalOpf(psi,s_da_0_cell,params)
    ...
    for i_episode=1:params.N_episode
        ...
        for t = 1:N_stpes
            if(mod(s_t.t,24)==1) %beginning of the day
                ...
                if(i_episode == 1 )
                    da_market = getDailyGenerationPrediction_externalOpf(da_action,s_da_td,params);
%                         da_market=zeros(params.ng,params.da_horizon);
                end
